...
<script src="<?= BASE_ASSET; ?>include/js/jquery.hotkeys.js"></script>
                  ...
                  <input type="hidden" value="" name="menu_type_id">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen  chosen-select-deselect" name="parent" id="parent" tabi-ndex="5" data-placeholder="Select Parent">
                            <option value=""></option>
                            <?php foreach (getParent() as $row): ?>
                            <option value="<?= $row->id_menu; ?>"  ><?= ucwords($row->label); ?></option>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input  type="radio" name="category_id" class="flat-green menu_type" value="1" checked> Admin Menu
                            </label>
                            <label>
                            <input  type="radio" name="category_id" class="flat-green menu_type" value="2"> Landing
                            </label>
                            <small class="info help-block">
                             Type Of Menu.
                          </small>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen chosen-select" name="group[]" id="group" tabi-ndex="5" data-placeholder="Select Groups" multiple="">
                            ...
                            <option value="<?= $row->role_id; ?>"  ><?= ucwords($row->role); ?></option>
  ...
  <div class="modal-dialog full-width " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <?php $this->load->view('backend/adminlte/modular/menu/partials_icon'); ?>
