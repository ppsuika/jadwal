		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="<?= get_template_dir(dirname(__FILE__), 'assets/images/'); ?>logo.png" height="35" alt="Porto Admin" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?= get_template_dir(dirname(__FILE__), 'assets/images/'); ?>!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?= get_template_dir(dirname(__FILE__), 'assets/images/'); ?>!sample-user.jpg" alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?= get_template_dir(dirname(__FILE__), 'assets/images/'); ?>!sample-user.jpg" alt="Joe Junior" class="img-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?= get_template_dir(dirname(__FILE__), 'assets/images/'); ?>!logged-user.jpg" alt="Joseph Doe" class="img-circle" data-lock-picture="<?= get_template_dir(dirname(__FILE__), 'assets/images/'); ?>!logged-user.jpg" />
							</figure>
